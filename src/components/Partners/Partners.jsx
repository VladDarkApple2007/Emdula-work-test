        ...
        <div className="relative w-full mask-linear-gradient">
          <div className="flex w-max animate-infinite-scroll hover:pause">
            ...
            {logos.map((logo, index) => (
              <div 
                key={`logo-1-${index}`} 
                className="mx-8 md:mx-16 flex items-center justify-center opacity-40 hover:opacity-100 transition-opacity duration-300 cursor-pointer"
              >
                <svg 
                  className="h-8 md:h-10 w-auto fill-current text-gray-800" 
                  viewBox="0 0 24 24" 
